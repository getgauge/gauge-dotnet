...
internal class StepExecutionStartingProcessorTests
{
    ...
    public async Task ShouldClearExistingGaugeMessages()
    {
        ...
        mockExecutionHelper.Setup(executor =>
                executor.ExecuteHooks(It.IsAny<string>(), It.IsAny<HooksStrategy>(), It.IsAny<IList<string>>(), It.IsAny<int>(), It.IsAny<ExecutionInfo>()))
        ...
        mockExecutionHelper.Setup(x =>
                x.ExecuteHooks("BeforeStep", It.IsAny<HooksStrategy>(), It.IsAny<IList<string>>(), It.IsAny<int>(), It.IsAny<ExecutionInfo>()))
            .ReturnsAsync(protoExecutionResult);
        mockExecutionHelper.Setup(x =>
        ...
        var processor = new StepExecutionStartingProcessor(mockExecutionHelper.Object, config);
